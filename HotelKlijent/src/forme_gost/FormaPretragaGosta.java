 ...
 * @author vanja
 */
public class FormaPretragaGosta extends javax.swing.JDialog {

    public FormaPretragaGosta(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Pretraga gosta");
        ModelTabeleGosti model = new ModelTabeleGosti();
    ...
    private void initComponents() {
        ...
        btnDetalji.setText("Detalji gosta");
    ...
    private void txtPretragaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPretragaKeyReleased
        ...
        ModelTabeleGosti mt = (ModelTabeleGosti) tblGosti.getModel();
    ...
    private void btnDetaljiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetaljiActionPerformed
        ...
        if (red >= 0) {
            Gost g = ((ModelTabeleGosti) tblGosti.getModel()).vratiGosta(red);
            new FormaDetaljiGosta(this, true, g).setVisible(true);
        }
