 ...
 * @author vanja
 */
public class FormaPretragaUsluga extends javax.swing.JDialog {

    public FormaPretragaUsluga(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Pretraga usluge");
        ModelTabeleUsluge model = new ModelTabeleUsluge();
    ...
    private void txtPretragaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPretragaKeyReleased
        ...
        ModelTabeleUsluge mt = (ModelTabeleUsluge) tblUsluge.getModel();
    ...
    private void btnDetaljiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetaljiActionPerformed
        ...
        if (red >= 0) {
            Usluga u = ((ModelTabeleUsluge) tblUsluge.getModel()).vratiUslugu(red);
            new FormaDetaljiUsluge(this, true, u).setVisible(true);
        }
